...
class Stooq52WeekTemplate(QuestionTemplate):
    ...
    PATTERNS = {
        Week52QueryType.HIGH_PRICE: [
            "What is the 52-week high of {instrument}? Check stooq.com.",
            "Find the 52-week high price for {instrument} on stooq.com.",
            "What was the highest price of {instrument} in the past 52 weeks? Use stooq.com.",
            "Check stooq.com for the 52-week high of {instrument}.",
        ],
        Week52QueryType.LOW_PRICE: [
            "What is the 52-week low of {instrument}? Check stooq.com.",
            "Find the 52-week low price for {instrument} on stooq.com.",
            "What was the lowest price of {instrument} in the past 52 weeks? Use stooq.com.",
            "Check stooq.com for the 52-week low of {instrument}.",
        ],
        Week52QueryType.DISTANCE_FROM_HIGH: [
            "How far is {instrument} from its 52-week high in percentage? Check stooq.com.",
            "What percentage below its 52-week high is {instrument} trading? Use stooq.com.",
            "Calculate how much {instrument} is down from its 52-week high. Check stooq.com.",
            "Find the percentage difference between {instrument}'s current price and 52-week high on stooq.com.",
        ],
        Week52QueryType.DISTANCE_FROM_LOW: [
            "How far is {instrument} from its 52-week low in percentage? Check stooq.com.",
            "What percentage above its 52-week low is {instrument} trading? Use stooq.com.",
            "Calculate how much {instrument} is up from its 52-week low. Check stooq.com.",
            "Find the percentage difference between {instrument}'s current price and 52-week low on stooq.com.",
        ],
        Week52QueryType.CLOSER_TO: [
            "Is {instrument} closer to its 52-week high or 52-week low? Check stooq.com.",
            "Check stooq.com: is {instrument} trading nearer to its 52-week high or low?",
            "Determine whether {instrument} is closer to its annual high or low on stooq.com.",
            "Using stooq.com, find if {instrument} is nearer to its 52-week high or 52-week low.",
        ],
    }
